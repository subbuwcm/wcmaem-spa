...
import subbu.blogspot.wcmaem.spa.models.HierarchyPage;
...
public class HierarchyPageImpl implements HierarchyPage {
     ...
     */
    protected static final String RESOURCE_TYPE = "spaexamples/components/page";
     ...
     */
    private static final String HIERARCHY_ENTRY_POINT_PAGE_ATTR = "subbu.blogspot.wcmaem.spa.internal.models.entryPointPage";

    /**
     * Flags the child pages. Optionally available as a request attribute
     */
    private static final String IS_CHILD_PAGE_ATTR = "subbu.blogspot.wcmaem.spa.internal.models.isChildPage";
